...
set( S_TERM_A     , T_RBRACK     , 51 );
set( S_TERM_A     , T_COMMA      , 51 );
set( S_FACT       , T_VAR        , 52 );
set( S_FACT_A     , T_LBRACK     , 53 );
set( S_FACT_A     , T_LPAR       , 54 );
set( S_FACT_A     , T_RPAR       , 55 );
set( S_FACT_A     , T_BOOL_OP    , 55 );
set( S_FACT_A     , T_SEMI       , 55 );
set( S_FACT_A     , T_MINUS      , 55 );
set( S_FACT_A     , T_PLUS       , 55 );
set( S_FACT_A     , T_MULT       , 55 );
set( S_FACT_A     , T_CMP        , 55 );
set( S_FACT_A     , T_RBRACK     , 55 );
set( S_FACT_A     , T_COMMA      , 55 );
set( S_FACT       , T_NUMBER     , 56 );
set( S_FACT       , T_MINUS      , 57 );
set( S_FACT       , T_LPAR       , 58 );
set( S_COND_EXP   , T_NUMBER     , 59 );
set( S_COND_EXP   , T_VAR        , 59 );
set( S_COND_EXP   , T_LPAR       , 59 );
set( S_COND_EXP   , T_MINUS      , 59 );
set( S_COND_EXP_A , T_BOOL_OP    , 60 );
set( S_COND_EXP_A , T_RPAR       , 61 );
set( S_COND       , T_NUMBER     , 62 );
set( S_COND       , T_VAR        , 62 );
set( S_COND       , T_LPAR       , 62 );
set( S_COND       , T_MINUS      , 62 );
set( S_BLOCK      , T_LCURL      , 63 );
set( S_EXP_LIST   , T_VAR        , 64 );
set( S_EXP_LIST   , T_NUMBER     , 64 );
set( S_EXP_LIST   , T_MINUS      , 64 );
set( S_EXP_LIST   , T_LPAR       , 64 );
set( S_EXP_LIST   , T_STRING     , 65 );
set( S_EXP_LIST   , T_RPAR       , 66 );
set( S_EXP_LIST_A , T_COMMA      , 67 );
set( S_EXP_LIST_A , T_RPAR       , 68 );
set( S_EXP_LIST_B , T_VAR        , 69 );
set( S_EXP_LIST_B , T_NUMBER     , 69 );
set( S_EXP_LIST_B , T_MINUS      , 69 );
set( S_EXP_LIST_B , T_LPAR       , 69 );
set( S_EXP_LIST_B , T_STRING     , 70 );
