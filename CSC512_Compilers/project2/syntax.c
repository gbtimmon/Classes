...
S_BRACK_EXP   :: T_e                                                             FIRST+: T_COMMA  T_SEMI T_RPAR T_BOOL_OP T_EQ T_LPAR T_RPAR
...
S_STATEMENT_A :: S_BRACK_EXP  T_EQ          S_EXP        T_SEMI      S_STATEMENT FIRST+: T_LBRACK T_EQ
S_STATEMENT_A :: T_LPAR       S_EXP_LIST    T_RPAR       T_SEMI      S_STATEMENT FIRST+: T_LPAR
// While or if
...
S_EXP_A       :: T_e                                                             FIRST+: T_RPAR T_SEMI T_RBRACK T_CMP T_BOOL_OP
